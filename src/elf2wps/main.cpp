 ...
 */
static bool
writeWps(ElfFile &file, const std::string &filename)
{
   ...
   if (out.tellp() < 11)
   {
      fmt::print("Output file is too small to patch header\n");
      return false;
   }

   out.seekp(9, std::ios::beg);
   const std::array<char, 2> marker = {'P', 'L'};
...
int main(int argc, char **argv)
{
   ...
   if (!writeWps(elf, dst)) {
      fmt::print("ERROR: writeWps failed.\n");
      return -1;
   }
